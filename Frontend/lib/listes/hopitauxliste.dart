...
class HopitauxListPage extends StatefulWidget {
  @override
  _HopitauxListPageState createState() => _HopitauxListPageState();
}

class _HopitauxListPageState extends State<HopitauxListPage> {
  int nbr = 0;
  int idnb = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appbarfix(
          title: '${getLang(context, "Hopitaux")}',
          i: nbr - nbrn,
          idnb: id,
          nb: nbr,
          init: init),
