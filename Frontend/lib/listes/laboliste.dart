...
class LaboListPage extends StatefulWidget {
  @override
  _LaboListPageState createState() => _LaboListPageState();
}

class _LaboListPageState extends State<LaboListPage> {
  int nbr = 0;
  int idnb = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appbarfix(
          title: '${getLang(context, "Laboratories")}',
          i: nbr - nbrn,
          idnb: id,
          nb: nbr,
          init: init),
